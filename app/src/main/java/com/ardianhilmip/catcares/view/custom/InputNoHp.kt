...
class InputNoHp: AppCompatEditText {
    ...
    private fun init() {
        iconFormInput = context.getDrawable(R.drawable.ic_outline_phone_24) as Drawable
        showIconFormInput()
    ...
    override fun onDraw(canvas: Canvas?) {
        ...
        context.apply {
            ...
            hint = context.getString(R.string.input_no_hp)
            textSize = 15f
