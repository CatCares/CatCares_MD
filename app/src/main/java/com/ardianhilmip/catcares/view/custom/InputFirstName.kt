...
class InputFirstName : AppCompatEditText {
    ...
    private fun init() {
        iconFormInput = context.getDrawable(R.drawable.ic_outline_person_24) as Drawable
        showIconFormInput()
        ...
        addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(s: CharSequence, start: Int, before: Int, count: Int) {
                ...
                error = if (s.isNotEmpty()) {
                    if (s.length > 15) {
                        context.getString(R.string.first_name_long)
                    } else null
                } else null
            }
    ...
    override fun onDraw(canvas: Canvas?) {
        ...
        context.apply {
            ...
            hint = context.getString(R.string.input_first_name)
            textSize = 15f
