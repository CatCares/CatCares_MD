...
class ArticlePagingSource(
...
) : PagingSource<Int, ArticleDataItem>() {

    override fun getRefreshKey(state: PagingState<Int, ArticleDataItem>): Int? {
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, ArticleDataItem> {
        return try {
